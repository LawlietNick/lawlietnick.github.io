...
6. **[KEY_RESOLUTION/RECOMMENDATION]:** (The single, most important action/answer, e.g., "We must adopt a centralized cloud architecture by Q3.")
...
---
## **PRESENTATION OUTLINE: [TOPIC_TITLE]**

### **I. Introduction (SCQR - The Hook)**
* **Slide 1: Title & Context**
    * **S (Situation):** [Draft 1-2 sentences of agreed-upon, relevant context for the audience.]
    * **C (Complication):** [Draft 1-2 compelling sentences stating the core challenge, risk, or urgency, referencing a **[CORE_DATA_POINTS]** number.]
    * **Q (Question):** [Draft the single, simple question that the presentation will answer.]
* **Slide 2: Our Resolution (The Thesis)**
    * **R (Resolution/Level 1 Message):** [State the clear, concise **[KEY_RESOLUTION/RECOMMENDATION]** as the direct answer to 'Q'.]
...
* **Slide 3: Pillar 1: [Concise, Actionable Title 1]**
    * **Level 2 Point:** [Main finding/recommendation of this pillar.]
    * **Level 3 Support (Rationale & Evidence):** [Detail the *why* and *what* with a specific **[CORE_DATA_POINTS]** reference.]
    * **Client Impact:** [Explain the benefit to the **[AUDIENCE]**]

* **Slide 4-5: Pillar 2: [Concise, Actionable Title 2]**
    * **Level 2 Point:** [Main finding/recommendation of this pillar.]
...
* **Slide 6-7: Pillar 3: [Concise, Actionable Title 3]**
    * **Level 2 Point:** [Main finding/recommendation of this pillar.]
...
* **Slide 8: Financial Summary / Risk Mitigation (If necessary)**
